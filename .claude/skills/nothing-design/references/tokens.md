...
| `--text-disabled` | `#666666` | 4.0:1 | Disabled, decorative |
| `--text-secondary` | `#999999` | 6.3:1 | Labels, captions |
...
| Token | Hex | Usage |
|-------|-----|-------|
| `--accent` | `#D71921` | Signal: active states, destructive, urgent. One per screen. |
| `--accent-subtle` | `rgba(215,25,33,0.15)` | Accent tint backgrounds |
| `--success` | `#4A9E5C` | Confirmed, completed |
| `--warning` | `#D4A843` | Caution, pending |
| `--error` | `#D71921` | Shares accent red |
| `--info` | `#999999` | Uses secondary text |
| `--interactive` | `#007AFF` / `#5B9BF6` | Tappable text: links, pickers |
...
- Monoline, 1.5px stroke, no fill. 24x24 base, 20x20 live area.
- Round caps/joins. Max 5–6 strokes.
